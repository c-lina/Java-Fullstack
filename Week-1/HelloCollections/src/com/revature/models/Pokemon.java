...
public class Pokemon {
    ...
    //Based on the pokemon's levels, so we can determine if it wins the fight
    ...
    Combined with private variables, this allows us to achieve ENCAPSULATION
    ...
    We cannot change or access private variables without some kind of methods to do so
     ...
     you want ONE SPECIFIC WAY to view or change the data stores in our variables
